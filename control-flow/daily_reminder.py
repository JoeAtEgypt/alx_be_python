...
match priority:
    case "high":
        if time_bound == "yes":
            ...
            print(
                f"Reminder: '{task}' is a high priority task. Try to complete it as soon as possible."
            )
    case "medium":
        if time_bound == "yes":
            print(
                f"Reminder: '{task}' is a medium priority task that should be done today."
            )
        else:
    ...
    case "low":
        if time_bound == "yes":
            print(
                f"Note: '{task}' is a low priority task, but it is time-bound. Don't forget to do it today!"
            )
        else:
            print(
